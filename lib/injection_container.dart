...
Future<void> setupInjection(ProviderContainer container) async {
  getIt.registerLazySingleton<DioClient>(
        () => DioClient('https://api-qa.welda.co.kr', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjYwMDAxMzk3LCJ1c2VyTmFtZSI6IuyWkeyEseyjvCIsIm5pY2tOYW1lIjoi7ISx7KO8IHFhIiwidXNlclR5cGUiOiJVIiwibm9kZUVudiI6InFhIiwiaWF0IjoxNzQzNzc0NTg3LCJleHAiOjE3NTIyNTc0NTg3fQ.ue_qRPkun1tnfbsD4WvaUadYmhmjoGXJduNCpw-nIrA'),
  );
